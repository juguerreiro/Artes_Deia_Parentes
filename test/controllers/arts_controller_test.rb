...
class ArtsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create art" do
    assert_difference('Art.count') do
      post arts_url, params: { art: { description: @art.description, is_avaiable: @art.is_avaiable, name: @art.name, price: @art.price, type: @art.type, user_id: @art.user_id } }
    end
  ...
  test "should update art" do
    patch art_url(@art), params: { art: { description: @art.description, is_avaiable: @art.is_avaiable, name: @art.name, price: @art.price, type: @art.type, user_id: @art.user_id } }
